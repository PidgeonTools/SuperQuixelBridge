        ...
        try:
            ...
            if globals()['Megascans_DataSet'] != None:
                ...
                for js in self.json_Array:
                    ...
                    self.SelectedColorManagement = bpy.context.scene.display_settings.display_device
    ...
    def SetupMaterial (self):
        ...
        if self.isSpecularWorkflow:
            if "specular" in self.textureTypes:
                self.CreateTextureNode("specular", -1150, 200, 1, True, 7)
        ...
        if "opacity" in self.textureTypes:
            self.CreateTextureNode("opacity", -1550, -160, 1, True, 20)
            self.mat.blend_method = 'HASHED'

        if "translucency" in self.textureTypes:
            self.CreateTextureNode("translucency", -1550, -420, 0, False, 17)
        elif "transmission" in self.textureTypes:
            self.CreateTextureNode("transmission", -1550, -420, 1, False, 17)
